...
{
    use Queueable;
    // protected $details; // Define the details property
    ...
    //specify the channels the notification should be sent through
    {
        return ['mail'];
    }
    ...
    //specify the mail representation of the notification
    {
